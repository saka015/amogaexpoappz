...
function SelectTrigger({
  ...
  return (
    ...
    >
      {children}
      <LucideIcon name='ChevronDown' size={16} aria-hidden={true} className='text-foreground opacity-50' />
    </SelectPrimitive.Trigger>
  );
}
...
function SelectScrollUpButton({ className, ...props }: SelectPrimitive.ScrollUpButtonProps) {
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <LucideIcon name="ChevronUp" size={16} className='text-foreground' />
    </SelectPrimitive.ScrollUpButton>
  );
}
...
function SelectScrollDownButton({ className, ...props }: SelectPrimitive.ScrollDownButtonProps) {
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <LucideIcon name="ChevronDown" size={16} className='text-foreground' />
    </SelectPrimitive.ScrollDownButton>
  );
}
    ...
    >
      <View className='absolute left-2 native:left-3.5 flex h-3.5 native:pt-px w-3.5 items-center justify-center'>
        <SelectPrimitive.ItemIndicator>
          <LucideIcon name="Check" size={16} className='text-popover-foreground' />
        </SelectPrimitive.ItemIndicator>
      </View>
