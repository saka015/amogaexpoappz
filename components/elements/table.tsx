...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Root
    ref={ref}
    className={cn('w-full caption-bottom text-sm table border-collapse', className)}
    {...props}
  />
));
...
>(({ className, style, ...props }, ref) => (
  <TablePrimitive.Body
    ref={ref}
    className={cn('table-row-group border-border', className)}
...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Row
    ref={ref}
    className={cn(
      'table-row border-b border-border last:border-b-0 web:transition-colors web:hover:bg-muted/50 web:data-[state=selected]:bg-muted',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TextClassContext.Provider value='text-muted-foreground'>
    <TablePrimitive.Head
      ref={ref}
      className={cn(
        'table-cell h-10 px-4 text-left font-medium align-middle [&:has([role=checkbox])]:pr-0',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Cell
    ref={ref}
    className={cn('table-cell p-4 py-2 align-middle [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
));
