      ...
      ({ item }: ListRenderItemInfo<unknown>) => {
        ...
        return (
          ...
          >
            ...
            {isSelected && <LucideIcon name="Check" size={16} className={'text-foreground px-6 mt-1.5'} />}
          </Button>
        );
      },
      [selectedItem, selectedItemProp]
      ...
      <BottomSheet>
        ...
        >
          <View className='flex-1 flex-row justify-between '>
            ...
            <LucideIcon name="ChevronsUpDown" className='text-foreground ml-2 opacity-50' />
          </View>
        </BottomSheetOpenTrigger>
        <BottomSheetContent
          ref={bottomSheet.ref}
        ...
        >
          ...
          <View className='relative px-4 border-b border-border pb-4'>
            ...
            >
              <LucideIcon name="Search" size={16} className='text-foreground opacity-50' />
            </Button>
          </View>
          <BottomSheetFlatList
            data={listItems}
