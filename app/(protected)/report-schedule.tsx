                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen} className=''>
                    ...
                    <DialogContent className="w-[90vw] max-w-lg max-h-screen m-4 p-0" style={{ paddingBottom: bottom }}>
                        ...
                        <DialogHeader className='p-6'>
                            <DialogTitle>{editingPrompt ? 'Edit Report Schedule' : 'New Report Schedule'}</DialogTitle>
                        </DialogHeader>
                        <ScrollView className='py-4 p-6'>
                            <PromptForm control={control} errors={errors} />
                            <ScheduleForm control={control} errors={errors} setValue={setValue} getValues={getValues} session={session} nextExecution={nextExecution} deliveryOptions={[{ id: 'email', label: 'Send as Email' }]} />
                        </ScrollView>
